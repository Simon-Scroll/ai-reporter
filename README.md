...
Un jour sans **article** est le cas normal. Un jour sans **note de desk** publique ne l’est plus : le site affiche un court message après chaque run. Le journal n’est pas rendu sur le site. `main` est la mémoire.
