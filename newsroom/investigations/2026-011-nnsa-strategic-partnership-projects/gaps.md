...
- GAO's report-level description does not identify a site-level SPP agreement, sponsor, contract modification, or closeout record that can be independently traced.
- The public NNSA page describes the program but does not disclose project-level funding, actual costs, or closeout data.
- DOE Order 481.1E requires written certifications, performance measures, active-agreement summaries, and policy-compliance records, but no such record has yet been retrieved for a defined SPP project.
