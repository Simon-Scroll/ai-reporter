...
3. The day starts from the open questions, not from the new documents. Decide every open thread before choosing a new subject. Read the day’s horizon for the record those threads are missing. Do not start a new investigation while an open thread can still advance or be written. Open threads are not a trap: every run must **continue, park, or kill** each of them in writing before repeating yesterday’s fetch. Use judgment. Caps exist so the desk cannot drown; they are not a reason to open a weak lead.
